        ...
        <div className="space-y-8">
          ...
          <Card
            ...
            <motion.div
              ...
              <p className="text-gray-300 text-lg leading-relaxed">
                Born and raised in Cleveland, Oh. When I'm not busy developing, you'll likely find me playing with my dogs, deep into the latest RPG, or cooking some delicious!
              </p>
            </motion.div>
          </Card>
