    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          {/* Modal content */}
          <motion.div
            className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full max-w-2xl max-h-[90vh] overflow-y-auto bg-gradient-to-b from-gray-900 to-gray-800 rounded-xl border border-blue-500/20 shadow-xl z-50 text-white p-6"
